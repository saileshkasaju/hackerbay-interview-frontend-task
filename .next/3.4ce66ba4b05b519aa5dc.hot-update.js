      ...
      this.body.onkeydown = function (e) {
        ...
        if (x >= 0 && x < width && y >= 0 && y < height) {
          ...
          if (_this2.activeCells.includes(newPos)) {
            ...
            _this2.activeCells = [].concat(_toConsumableArray(_this2.activeCells.splice(0, index)), _toConsumableArray(_this2.activeCells.splice(index)));
          }
...
//# sourceMappingURL=3.4ce66ba4b05b519aa5dc.hot-update.js.map