      ...
      this.body.onkeydown = function (e) {
        ...
        if (x >= 0 && x < width && y >= 0 && y < height) {
          ...
          if (_this2.activeCells.includes(newPos)) {
            ...
            _this2.activeCells = [].concat(_toConsumableArray(_this2.activeCells.splice(0, index)), _toConsumableArray(_this2.activeCells.splice(index + 1)));
          }
...
//# sourceMappingURL=3.7f0b70724882b1161169.hot-update.js.map