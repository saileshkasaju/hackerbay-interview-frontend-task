      ...
      this.body.onkeydown = function (e) {
        ...
        if (x >= 0 && x < width && y >= 0 && y < height) {
          ...
          if (_this2.activeCells.includes(newPos)) {
            ...
            _this2.activeCells = [].concat(_toConsumableArray(_this2.activeCells.splice(0, index - 1)), _toConsumableArray(_this2.activeCells.splice(index)));
          }
...
//# sourceMappingURL=3.579d9bca9e78e86dbda6.hot-update.js.map